...
const pretestSplits = [
  { split_id: "you5_other95", you: 5, other: 95 },
  { split_id: "you10_other90", you: 10, other: 90 },
  { split_id: "you15_other85", you: 15, other: 85 },
  { split_id: "you20_other80", you: 20, other: 80 },
  { split_id: "you25_other75", you: 25, other: 75 },
  { split_id: "you30_other70", you: 30, other: 70 },
  { split_id: "you35_other65", you: 35, other: 65 },
  { split_id: "you40_other60", you: 40, other: 60 },
  { split_id: "you45_other55", you: 45, other: 55 }
];
  ...
  positions.forEach(function (position) {
    colorBalances.forEach(function (colors) {
      rows.push({
        ...
        condition_label: `equal_radius_${position.position_condition}_${colors.color_balance}`,
...
function proposalRatingTrial(condition, split, trialIndex) {
  const trialNumber = trialIndex + 1;
  const questions = [
    {
      name: "willing_accept_7",
      text: "How willing would you be to accept this proposal?",
      left: "1 = Not willing at all",
      right: "7 = Very willing"
    },
    {
      name: "fairness_7",
  ...
  const html = shellHtml(`
    <form id="proposal-rating-form" class="stimulus-content pretest-rating-form" novalidate>
      ...
      <div class="offer-subtitle">
        Proposal ${trialNumber} of ${pretestSplits.length}. Please evaluate this proposal carefully.
      </div>
      <div class="rose-wrap pretest-rose-wrap">${roseChartHtml(stimulusCondition)}</div>
      <div class="amount-summary" aria-label="Numerical proposal amounts">
        <div><span>You</span><strong>${split.you} cents</strong></div>
        <div><span>Proposer</span><strong>${split.other} cents</strong></div>
      </div>
  ...
  return {
    ...
    on_load: function () {
      ...
      form.addEventListener("submit", function (event) {
        ...
        warning.style.display = "none";
        jsPsych.finishTrial({
          willing_accept_7: response.willing_accept_7,
          fairness_7: response.fairness_7,
          felt_difference_7: response.felt_difference_7,
          proposal_rating_rt: Math.round(performance.now() - pageStart),
          proposal_rating_rt_json: JSON.stringify(questionRt)
        });
      });
    }
  };
...
async function buildAndRunExperiment() {
  ...
  timeline.push({
    timeline: [...pretestRatingTrials(conditionInfo), ...postQuestionnaireTrials()],
    conditional_function: function () {
